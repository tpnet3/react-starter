        ...
        concat: function (x, y) {
            return x.isThis()
                ? y.isThis()
                    ...
                    : y.isThat() ? exports.both(x.value, y.value) : exports.both(SL.concat(x.value, y.l), y.a)
                : x.isThat()
                    ? y.isThis()
                        ? exports.both(y.value, x.value)
                        : y.isThat() ? exports.that(SA.concat(x.value, y.value)) : exports.both(y.l, SA.concat(x.value, y.a))
                    : y.isThis()
                        ? exports.both(SL.concat(x.l, y.value), x.a)
                        : y.isThat() ? exports.both(x.l, SA.concat(x.a, y.value)) : exports.both(SL.concat(x.l, y.l), SA.concat(x.a, y.a));
        }
    };
};
...
var chain = function (S) { return function (fa, f) {
    if (fa.isThis()) {
        ...
        return fb.isThis()
            ...
            : fb.isThat() ? exports.both(fa.l, fb.value) : exports.both(S.concat(fa.l, fb.l), fb.a);
    }
}; };
/**
 * @function
...
var traverse = function (F) { return function (ta, f) {
    return ta.isThis()
        ...
        : ta.isThat() ? F.map(f(ta.value), exports.that) : F.map(f(ta.a), function (b) { return exports.both(ta.l, b); });
}; };
/**
 * @function
 * @since 1.0.0
