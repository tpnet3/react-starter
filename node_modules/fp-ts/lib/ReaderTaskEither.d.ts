 ...
 * @since 1.6.0
 */
export declare const local: <E>(f: (e: E) => E) => <L, A>(fa: ReaderTaskEither<E, L, A>) => ReaderTaskEither<E, L, A>;
/**
 * @function
 * @since 1.6.0
 */
 ...
 * @since 1.6.0
 */
export declare const readerTaskEither: Monad3<URI> & Bifunctor3<URI> & Alt3<URI>;
