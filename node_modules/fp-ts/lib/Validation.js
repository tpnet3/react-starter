...
exports.getApplicative = function (S) {
    var ap = function (fab, fa) {
        return fab.isFailure()
            ? fa.isFailure() ? exports.failure(S.concat(fab.value, fa.value)) : exports.failure(fab.value)
            : fa.isFailure() ? exports.failure(fa.value) : exports.success(fab.value(fa.value));
    };
    return {
        URI: exports.URI,
...
exports.getSemigroup = function (SL, SA) {
    var concat = function (fx, fy) {
        return fx.isFailure()
            ? fy.isFailure() ? exports.failure(SL.concat(fx.value, fy.value)) : exports.failure(fx.value)
            : fy.isFailure() ? exports.failure(fy.value) : exports.success(SA.concat(fx.value, fy.value));
    };
    return {
        concat: concat
    };
